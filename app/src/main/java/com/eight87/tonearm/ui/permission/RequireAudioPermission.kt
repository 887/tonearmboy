...
import com.eight87.tonearm.data.mediastore.MediaStorePermissions
...
fun RequireAudioPermission(
  ...
  Box(
    ...
    Column(
      ...
      Text(
        "tonearm needs music access",
        style = MaterialTheme.typography.headlineSmall,
        textAlign = TextAlign.Center,
      )
      Text(
        "Grant the audio-library permission so tonearm can index your songs. " +
