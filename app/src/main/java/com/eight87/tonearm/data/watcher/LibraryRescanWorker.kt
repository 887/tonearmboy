 ...
 *
 * The worker delegates to [com.eight87.tonearm.data.LibraryRepository.rescanNow],
...
class LibraryRescanWorker(
  ...
  companion object {
    ...
    const val UNIQUE_WORK_NAME = "tonearm.library.rescan"
    /** Debounce window before the worker actually runs. */
    const val DEBOUNCE_SECONDS = 30L
    private const val TAG = "tonearm-watcher-worker"
  }
}
